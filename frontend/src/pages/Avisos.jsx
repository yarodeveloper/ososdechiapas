                ...
                <main className="px-6 space-y-8">
                    {announcements.length === 0 ? (
                        ...
                        announcements.map(ann => (
                            <div key={ann.id} className="rounded-[2.5rem] overflow-hidden shadow-2xl transition-all animate-fade border" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-main)' }}>
                                {ann.image_url && (
                                ...
                                <div className="p-8 space-y-5">
                                    ...
                                    <p className="text-sm font-medium leading-relaxed italic" style={{ color: 'var(--text-dim)' }}>
                                        {ann.content}
                                    </p>
                                    <div className="pt-4 border-t text-[9px] font-black uppercase tracking-widest opacity-40" style={{ borderColor: 'var(--border-main)', color: 'var(--text-dim)' }}>
