...
const FeedComponent = () => (
    <section className="py-24 px-6 bg-zinc-950 border-t border-zinc-900 border-b border-zinc-900">
      ...
      <div className="grid grid-cols-2 gap-2 mb-10 max-w-sm mx-auto">
         {[1,2,3,4].map(i => (
            <div key={i} className="aspect-square bg-zinc-900 rounded-2xl overflow-hidden relative group active:scale-[0.98] transition-all">
                <img 
      ...
      <div className="flex justify-center flex-col items-center gap-4">
        <button className="w-full max-w-xs border border-zinc-800 hover:border-red-600 py-4 px-8 rounded-2xl flex items-center justify-center gap-3 text-xs font-black uppercase tracking-widest transition-all">
